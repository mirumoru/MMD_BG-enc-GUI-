...
バッチファイル版より使いやすいようにGUI版を開発しました。まだ不具合などが発生する可能性があります。  

[バッチファイル版Downloads(ダウンロード)>>](https://bowlroll.net/file/239319)  
...
## 《注意事項》  
MMD_BG-enc(GUI)を使用して発生した損害,損失,などはみるもる(うp主)は責任を一切負いません。  
自己責任でご利用下さい。  
